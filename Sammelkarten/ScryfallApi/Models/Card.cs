...
namespace Scryfall.API.Models
{
    ...
    public partial class Card {
        private ImageUri _imageUris;
        private IList<CardFace> _cardFaces;
        ...
        public IList<CardFace> CardFaces {
            get => _cardFaces; set {
                _cardFaces = value;
                //if (_cardFaces?.FirstOrDefault()?.ImageUris?.BorderCrop != null) {
                //    ImageStream = new BitmapImage(new System.Uri(_imageUris.BorderCrop));
                //}
            } }
